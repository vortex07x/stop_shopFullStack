...
export const OrdersProvider = ({ children }) => {
  ...
  const fetchOrdersFromBackend = useCallback(async () => {
    ...
    try {
      const response = await fetch("https://stopshop-backend.onrender.com/api/orders/my-orders", {
        method: "GET",
  ...
  const placeOrder = useCallback(async (cartItems) => {
    ...
    try {
      ...
      const response = await fetch("https://stopshop-backend.onrender.com/api/orders/place-order", {
        method: "POST",
        headers: getAuthHeaders(),
