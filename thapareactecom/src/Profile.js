...
const Profile = () => {
  ...
  const handleGenerateNewAvatar = async () => {
    try {
      ...
      const response = await fetch("http://localhost:8080/api/user/avatar/generate", {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
  ...
  const fetchUserStats = async () => {
    try {
      ...
      try {
        ...
        const cartResponse = await fetch("http://localhost:8080/api/cart/my", {
          method: "GET",
          headers: { 
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json"
      ...
      try {
        ...
        const ordersResponse = await fetch("http://localhost:8080/api/orders/my-orders", {
          method: "GET",
          headers: { 
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json"
